...
function App() {
  ...
  return (
    <div className="min-h-screen  bg-dark-gray w-full p-5 sm:p-10 lg:p-5 flex flex-col">
      ...
      <p className='text-orange-500 font-bold mb-5'>
        Download Extention Absolute Enable Right Click & Copy dulu{' '}
        <a className='text-blue-500 underline' target='_blank' rel='noopener noreferrer' href="https://chromewebstore.google.com/detail/absolute-enable-right-cli/jdocbkpgdakpekjlhemmfcncgdjeiika?hl=en">
          di sini
        </a>
      </p>

      <div className='xl:flex lg:gap-5 h-full'>
        <form className='w-full xl:w-1/2 flex flex-col gap-5' onSubmit={handleSubmit}>
